...
const Edit = ({ goBack, id }) => {
  ...
  return (
    <main className="all">
      <form
        className={`sections ${darkMode ? "dark-section " : "light-section"}`}
      ...
      >
        <div className="form-contents">
          ...
          <h4 className={`title ${darkMode ? "dark-title" : "light-title"}`}>
            Edit <span className="titleh">#</span>
            {id}
          </h4>
          <form
          ...
          >
            <div className="bill-form-section">
              ...
              <input
                className={`in ${darkMode ? "dark-input" : "light-input "} ${
                  formErrors.senderStreet ? "border-error" : ""
                }`}
                type="text"
                name="senderStreet"
              ...
              <div className="addresses">
                <div className="addresses-row">
                  <div className="city">
                    ...
                    <input
                      className={`city-in in ${
                        darkMode ? "dark-input" : "light-input"
                      } ${formErrors.senderCity ? "border-error" : ""}`}
                      type="text"
                      name="senderCity"
                  ...
                  <div className="post">
                    ...
                    <input
                      className={`post-in in ${
                        darkMode ? "dark-input" : "light-input"
                      } ${formErrors.senderPostCode ? "border-error" : ""}`}
                      type="text"
                      name="senderPostCode"
                      maxLength="5"
                      minLength="5"
                ...
                <div className="county">
                  ...
                  <input
                    className={`county-in in ${
                      darkMode ? "dark-input" : "light-input"
                    } ${formErrors.senderCountry ? "border-error" : ""}`}
                    type="text"
                    name="senderCountry"
            ...
            <div className="bill-form-section">
              ...
              <input
                className={` in ${darkMode ? "dark-input" : "light-input"} ${
                  formErrors.clientName ? "border-error" : ""
                }`}
                type="text"
                name="clientName"
              ...
              <input
                className={` in ${darkMode ? "dark-input" : "light-input"} ${
                  formErrors.clientEmail ? "border-error" : ""
                }`}
                type="email"
                name="clientEmail"
              ...
              <input
                className={` in ${darkMode ? "dark-input" : "light-input"} ${
                  formErrors.clientStreet ? "border-error" : ""
                }`}
                type="text"
                name="clientStreet"
              ...
              <div className="addresses">
                <div className="addresses-row">
                  <div className="city">
                    ...
                    <input
                      className={`city-in in ${
                        darkMode ? "dark-input" : "light-input"
                      } ${formErrors.clientCity ? "border-error" : ""}`}
                      type="text"
                      name="clientCity"
                  ...
                  <div className="post">
                    ...
                    <input
                      className={`post-in in ${
                        darkMode ? "dark-input" : "light-input"
                      } ${formErrors.clientPostCode ? "border-error" : ""}`}
                      type="text"
                      name="clientPostCode"
                ...
                <div>
                  ...
                  <input
                    className={`county-in in ${
                      darkMode ? "dark-input" : "light-input"
                    } ${formErrors.clientCountry ? "border-error" : ""}`}
                    type="text"
                    name="clientCountry"
            ...
            <div className="invoice">
              <div className="invoice-row">
                <div>
                  ...
                  <input
                    className={`invoice-inputs opacity-50 in ${
                      darkMode ? "dark-input" : "light-input"
                    } ${formErrors.invoiceDate ? "border-error" : ""}`}
                    disabled={true}
                    type="date"
                    name="invoiceDate"
                ...
                <div className="selects">
                  ...
                  <div
                    className={`selects-item ${
                      darkMode ? "dark-select-items " : " light-select-items"
                    }`}
                  >
              ...
              <div className="project-description">
                ...
                <input
                  className={`project-in in ${
                    darkMode ? "dark-input" : "light-input"
                  } ${formErrors.description ? "border-error" : ""}`}
                  type="text"
                  name="description"
